...
public partial class OverridePS {
    ...
    /// logEmailAdd
    /// </summary>
    public static LogEmailAdd logEmailAdd
    {
        get => HttpData.Get<LogEmailAdd>("logEmailAdd")!;
        set => HttpData["logEmailAdd"] = value;
    }

    /// <summary>
    /// Page class for log_email
    /// </summary>
    public class LogEmailAdd : LogEmailAddBase
    {
        // Constructor
        public LogEmailAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public LogEmailAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class LogEmailAddBase : LogEmail
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "logEmailAdd";
        ...
        // Page name
        public string PageName => "LogEmailAdd";
        ...
        // Constructor
        public LogEmailAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("LogEmailList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "LogEmailView")
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            try {
                ...
                // Email_Type
                Email_Type.SetDbValue(rsnew, Email_Type.CurrentValue);

                // Email_To
                Email_To.SetDbValue(rsnew, Email_To.CurrentValue);

                // Email_Cc
                Email_Cc.SetDbValue(rsnew, Email_Cc.CurrentValue);

                // Email_Subject
                Email_Subject.SetDbValue(rsnew, Email_Subject.CurrentValue);

                // Email_Body
                Email_Body.SetDbValue(rsnew, Email_Body.CurrentValue);
            } catch (Exception e) {
                if (Config.Debug)
                    throw;
