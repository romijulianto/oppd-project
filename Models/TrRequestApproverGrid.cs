...
public partial class OverridePS {
    /// <summary>
    /// trRequestApproverGrid
    /// </summary>
    public static TrRequestApproverGrid trRequestApproverGrid
    {
        get => HttpData.Get<TrRequestApproverGrid>("trRequestApproverGrid")!;
        set => HttpData["trRequestApproverGrid"] = value;
    }

    /// <summary>
    /// Page class for tr_request_approver
    /// </summary>
    public class TrRequestApproverGrid : TrRequestApproverGridBase
    {
        // Constructor
        public TrRequestApproverGrid() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TrRequestApproverGridBase : TrRequestApprover
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "trRequestApproverGrid";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "ftr_request_approvergrid";
        ...
        // Constructor
        public TrRequestApproverGridBase()
        {
        ...
        // Page name
        public string PageName => "TrRequestApproverGrid";
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                trRequestApproverGrid?.PageRender();
            }
            return new EmptyResult();
        }
        #pragma warning restore 219
        ...
        public bool EmptyRow()
        {
            ...
            !(Position_Name.IsForeignKey && CurrentMasterTable != "" && SameString(Position_Name.CurrentValue, Position_Name.SessionValue)))
                return false;
            if (CurrentForm.HasValue("x_Approval_Status") && CurrentForm.HasValue("o_Approval_Status") && !SameString(Approval_Status.CurrentValue, Approval_Status.DefaultValue) &&
            !(Approval_Status.IsForeignKey && CurrentMasterTable != "" && SameString(Approval_Status.CurrentValue, Approval_Status.SessionValue)))
                return false;
            ...
            !(Approval_Date.IsForeignKey && CurrentMasterTable != "" && SameString(FormatDateTime(Approval_Date.CurrentValue, Approval_Date.FormatPattern), FormatDateTime(Approval_Date.SessionValue, Approval_Date.FormatPattern))))
                return false;
            if (CurrentForm.HasValue("x_Last_Update_By") && CurrentForm.HasValue("o_Last_Update_By") && !SameString(Last_Update_By.CurrentValue, Last_Update_By.DefaultValue) &&
            !(Last_Update_By.IsForeignKey && CurrentMasterTable != "" && SameString(Last_Update_By.CurrentValue, Last_Update_By.SessionValue)))
                return false;
            if (CurrentForm.HasValue("x_Created_By") && CurrentForm.HasValue("o_Created_By") && !SameString(FormatDateTime(Created_By.CurrentValue, Created_By.FormatPattern), FormatDateTime(Created_By.DefaultValue, Created_By.FormatPattern)) &&
            !(Created_By.IsForeignKey && CurrentMasterTable != "" && SameString(FormatDateTime(Created_By.CurrentValue, Created_By.FormatPattern), FormatDateTime(Created_By.SessionValue, Created_By.FormatPattern))))
                return false;
        ...
        public void ResetFormError()
        {
            ...
            Approval_Status.ClearErrorMessage();
        ...
        public async Task SetupRow()
        {
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(trRequestApproverGrid.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(trRequestApproverGrid.RowCount) + "_tr_request_approver");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(trRequestApproverGrid.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && trRequestApproverGrid.RowType == RowType.Add || IsEdit && trRequestApproverGrid.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'Approval_Status' before field var 'x_Approval_Status'
            val = CurrentForm.HasValue("Approval_Status") ? CurrentForm.GetValue("Approval_Status") : CurrentForm.GetValue("x_Approval_Status");
            if (!Approval_Status.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("Approval_Status") && !CurrentForm.HasValue("x_Approval_Status")) // DN
                    Approval_Status.Visible = false; // Disable update for API request
                else
                    Approval_Status.SetFormValue(val);
            }
            if (CurrentForm.HasValue("o_Approval_Status"))
                Approval_Status.OldValue = CurrentForm.GetValue("o_Approval_Status");
            ...
            if (CurrentForm.HasValue("o_Last_Update_By"))
                Last_Update_By.OldValue = CurrentForm.GetValue("o_Last_Update_By");
            ...
            if (!Created_By.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("Created_By") && !CurrentForm.HasValue("x_Created_By")) // DN
                    ...
                    Created_By.SetFormValue(val, true, validate);
                Created_By.CurrentValue = UnformatDateTime(Created_By.CurrentValue, Created_By.FormatPattern);
            }
            Created_By.OldValue = UnformatDateTime(CurrentForm.GetValue("o_Created_By"), Created_By.FormatPattern);
        ...
        public void RestoreFormValues()
        {
            ...
            Approval_Status.CurrentValue = Approval_Status.FormValue;
        ...
        protected async Task<bool> ValidateForm() {
            ...
            if (Approval_Status.Required) {
                if (!Approval_Status.IsDetailKey && Empty(Approval_Status.FormValue)) {
                    Approval_Status.AddErrorMessage(ConvertToString(Approval_Status.RequiredErrorMessage).Replace("%s", Approval_Status.Caption));
                }
            }
            ...
            if (!CheckDate(Created_By.FormValue, Created_By.FormatPattern)) {
                Created_By.AddErrorMessage(Created_By.GetErrorMessage(false));
            }
        ...
        protected async Task<JsonBoolResult> EditRow() { // DN
            ...
            // Approval_Status
            Approval_Status.SetDbValue(rsnew, Approval_Status.CurrentValue, Approval_Status.ReadOnly);
            ...
            // Last_Update_By
            Last_Update_By.SetDbValue(rsnew, Last_Update_By.CurrentValue, Last_Update_By.ReadOnly);

            // Created_By
            Created_By.SetDbValue(rsnew, ConvertToDateTime(Created_By.CurrentValue, Created_By.FormatPattern), Created_By.ReadOnly);
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            try {
                ...
                // Approval_Status
                Approval_Status.SetDbValue(rsnew, Approval_Status.CurrentValue);

                // Approval_Date
                Approval_Date.SetDbValue(rsnew, ConvertToDateTime(Approval_Date.CurrentValue, Approval_Date.FormatPattern));

                // Last_Update_By
                Last_Update_By.SetDbValue(rsnew, Last_Update_By.CurrentValue);

                // Created_By
                Created_By.SetDbValue(rsnew, ConvertToDateTime(Created_By.CurrentValue, Created_By.FormatPattern));
