...
public partial class OverridePS {
    ...
    /// mtUserEdit
    /// </summary>
    public static MtUserEdit mtUserEdit
    {
        get => HttpData.Get<MtUserEdit>("mtUserEdit")!;
        set => HttpData["mtUserEdit"] = value;
    }

    /// <summary>
    /// Page class for mt_user
    /// </summary>
    public class MtUserEdit : MtUserEditBase
    {
        // Constructor
        public MtUserEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtUserEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtUserEditBase : MtUser
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtUserEdit";
        ...
        // Page name
        public string PageName => "MtUserEdit";
        ...
        // Constructor
        public MtUserEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsApi()) {
                ...
                if (RouteValues.TryGetValue("_UserName", out rv)) { // DN
                    _UserName.FormValue = UrlDecode(rv); // DN
                    _UserName.OldValue = _UserName.FormValue;
                } else if (CurrentForm.HasValue("x__UserName")) {
                    _UserName.FormValue = CurrentForm.GetValue("x__UserName");
                    _UserName.OldValue = _UserName.FormValue;
                } else if (!Empty(keyValues)) {
                    _UserName.OldValue = ConvertToString(keyValues[0]);
                } else {
                ...
                if (!Empty(Post("action"))) {
                    ...
                    if (RouteValues.TryGetValue("_UserName", out rv)) { // DN
                        ...
                        _UserName.CurrentValue = DbNullValue;
                    }
                }
        ...
        if (postBack) {
            ...
            if (IsApi() && RouteValues.TryGetValue("key", out object? k)) {
                ...
                _UserName.FormValue = ConvertToString(keyValues[0]);
            }
        }
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("MtUserList"); // No matching record, return to list
                        }
                    break;
        ...
        protected async Task<JsonBoolResult> EditRow() { // DN
            ...
            UserPassword.SetDbValue(rsnew, UserPassword.CurrentValue, UserPassword.ReadOnly || Config.EncryptedPassword && SameString(rsold["UserPassword"], UserPassword.CurrentValue));
            ...
            // UserEmail
            UserEmail.SetDbValue(rsnew, UserEmail.CurrentValue, UserEmail.ReadOnly);
            ...
            // Department
            Department.SetDbValue(rsnew, Department.CurrentValue, Department.ReadOnly);
