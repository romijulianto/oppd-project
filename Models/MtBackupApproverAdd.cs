...
public partial class OverridePS {
    ...
    /// mtBackupApproverAdd
    /// </summary>
    public static MtBackupApproverAdd mtBackupApproverAdd
    {
        get => HttpData.Get<MtBackupApproverAdd>("mtBackupApproverAdd")!;
        set => HttpData["mtBackupApproverAdd"] = value;
    }

    /// <summary>
    /// Page class for mt_backup_approver
    /// </summary>
    public class MtBackupApproverAdd : MtBackupApproverAddBase
    {
        // Constructor
        public MtBackupApproverAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtBackupApproverAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtBackupApproverAddBase : MtBackupApprover
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtBackupApproverAdd";
        ...
        // Constructor
        public MtBackupApproverAddBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtBackupApproverAdd";
        ...
        // Constructor
        public MtBackupApproverAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MtBackupApproverList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "MtBackupApproverView")
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtBackupApproverAdd?.PageRender();
            }
            return PageResult();
        }
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            try {
                ...
                // Report_To
                Report_To.SetDbValue(rsnew, Report_To.CurrentValue);
