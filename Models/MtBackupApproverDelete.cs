...
public partial class OverridePS {
    /// <summary>
    /// mtBackupApproverDelete
    /// </summary>
    public static MtBackupApproverDelete mtBackupApproverDelete
    {
        get => HttpData.Get<MtBackupApproverDelete>("mtBackupApproverDelete")!;
        set => HttpData["mtBackupApproverDelete"] = value;
    }

    /// <summary>
    /// Page class for mt_backup_approver
    /// </summary>
    public class MtBackupApproverDelete : MtBackupApproverDeleteBase
    {
        // Constructor
        public MtBackupApproverDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtBackupApproverDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtBackupApproverDeleteBase : MtBackupApprover
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtBackupApproverDelete";
        ...
        // Constructor
        public MtBackupApproverDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtBackupApproverDelete";
        ...
        // Constructor
        public MtBackupApproverDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtBackupApproverList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtBackupApproverList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtBackupApproverDelete?.PageRender();
            }
            return PageResult();
        }
