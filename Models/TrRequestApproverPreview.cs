...
public partial class OverridePS {
    /// <summary>
    /// trRequestApproverPreview
    /// </summary>
    public static TrRequestApproverPreview trRequestApproverPreview
    {
        get => HttpData.Get<TrRequestApproverPreview>("trRequestApproverPreview")!;
        set => HttpData["trRequestApproverPreview"] = value;
    }

    /// <summary>
    /// Page class for tr_request_approver
    /// </summary>
    public class TrRequestApproverPreview : TrRequestApproverPreviewBase
    {
        // Constructor
        public TrRequestApproverPreview(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TrRequestApproverPreview() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TrRequestApproverPreviewBase : TrRequestApprover
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "trRequestApproverPreview";
        ...
        // Constructor
        public TrRequestApproverPreviewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "TrRequestApproverPreview";
        ...
        // Constructor
        public TrRequestApproverPreviewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        protected void HideFieldsForAddEdit() {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                trRequestApproverPreview?.PageRender();
            }
                return PageResult();
            }
