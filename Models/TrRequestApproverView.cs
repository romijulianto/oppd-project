...
public partial class OverridePS {
    /// <summary>
    /// trRequestApproverView
    /// </summary>
    public static TrRequestApproverView trRequestApproverView
    {
        get => HttpData.Get<TrRequestApproverView>("trRequestApproverView")!;
        set => HttpData["trRequestApproverView"] = value;
    }

    /// <summary>
    /// Page class for tr_request_approver
    /// </summary>
    public class TrRequestApproverView : TrRequestApproverViewBase
    {
        // Constructor
        public TrRequestApproverView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TrRequestApproverView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TrRequestApproverViewBase : TrRequestApprover
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "trRequestApproverView";
        ...
        // Constructor
        public TrRequestApproverViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "TrRequestApproverView";
        ...
        // Constructor
        public TrRequestApproverViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "TrRequestApproverList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("TrRequestApproverList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                trRequestApproverView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"ftr_request_approverview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("TrRequestApproverList")), "", TableVar, true);
            string pageId = "view";
