...
public partial class OverridePS {
    ...
    public static partial class Config
    {
        ...
        // Product version
        public const string ProductVersion = "20.6.0";

        // Project
        public const string ProjectNamespace = "OverridePSDashboard";

        public const string ProjectClassName = "OverridePSDashboard.Models.OverridePS"; // DN
        ...
        public const string ProjectName = "OverridePS"; // Project name

        public static string ControllerName { get; set; } = "Home"; // Controller name // DN

        public const string ProjectId = "{74850334-D87A-4E71-B45A-50C64B48A90E}"; // Project ID (GUID)

        public static string RandomKey = "r9WDeh528zv5Trqq"; // Random key for encryption

        public static string EncryptionKey = ""; // Encryption key for data protection

        public static string ProjectStylesheetFilename = "css/OverridePS.css"; // Project stylesheet file name (relative to wwwroot)
        ...
        public static string SidebarClass = "main-sidebar sidebar-dark-yellow"; // CSS class(es) for sidebar

        public static string NavbarClass = "main-header navbar navbar-expand navbar-yellow navbar-dark border-bottom-0"; // CSS class(es) for navbar
        ...
        // Export Log
        public static string ExportPath = "export-74850334-d87a-4e71-b45a-50c64b48a90e"; // Export folder
        ...
        public static string UserTableName = "mt_user";

        public static string LoginUsernameFieldName = "UserName";

        public static string LoginPasswordFieldName = "UserPassword";
        ...
        public static string UserTable = "dbo.mt_user";
        ...
        {
            {"log_API", typeof(LogApi)},
            {"log_email", typeof(LogEmail)},
            {"mt_param", typeof(MtParam)},
            {"mt_reason", typeof(MtReason)},
            {"mt_template_email", typeof(MtTemplateEmail)},
            {"mt_user", typeof(MtUser)},
            {"tr_request", typeof(TrRequest)},
            {"tr_request_approval_history", typeof(TrRequestApprovalHistory)},
            {"tr_request_approver", typeof(TrRequestApprover)},
            {"tr_request_detail", typeof(TrRequestDetail)},
            {"UserLevelPermissions", typeof(UserLevelPermissions)},
            {"UserLevels", typeof(UserLevels)},
            {"v_tr_request", typeof(VTrRequest)},
            {"mt_approver", typeof(MtApprover)},
            {"mt_backup_approver", typeof(MtBackupApprover)},
        ...
        public static Dictionary<string, string> DbIds = new ()
        {
            ...
            {"mt_param", "DB"},
            {"mt_reason", "DB"},
            {"mt_template_email", "DB"},
            {"mt_user", "DB"},
            {"tr_request", "DB"},
            {"tr_request_approval_history", "DB"},
            {"tr_request_approver", "DB"},
            {"tr_request_detail", "DB"},
            {"UserLevelPermissions", "DB"},
            {"UserLevels", "DB"},
            {"v_tr_request", "DB"},
            {"mt_approver", "DB"},
            {"mt_backup_approver", "DB"},
        };
        ...
        {
            new object[] { 30, "mi_WelcomePage", "30", "WelcomePage", -1, "", "{74850334-D87A-4E71-B45A-50C64B48A90E}WelcomePage", false, false, "fa-house", "", false, true },
            new object[] { 15, "mci_Override_PS", "15", "", -1, "", true, false, true, "fa-dollar-sign", "", false, true },
            new object[] { 7, "mi_tr_request", "7", "TrRequestList", 15, "", "{74850334-D87A-4E71-B45A-50C64B48A90E}tr_request", false, false, "fa-list-ul", "", false, true },
            new object[] { 31, "mi_v_tr_request", "31", "VTrRequestList", 15, "", "{74850334-D87A-4E71-B45A-50C64B48A90E}v_tr_request", false, false, "fa-circle-check", "", false, true },
            new object[] { 14, "mci_Reports", "14", "", -1, "", true, false, true, "fa-line-chart", "", false, true },
            new object[] { 1, "mi_log_API", "1", "LogApiList", 14, "", "{74850334-D87A-4E71-B45A-50C64B48A90E}log_API", false, false, "fa-clock-rotate-left", "", false, true },
            new object[] { 2, "mi_log_email", "2", "LogEmailList", 14, "", "{74850334-D87A-4E71-B45A-50C64B48A90E}log_email", false, false, "fa-envelope-circle-check", "", false, true },
            new object[] { 29, "mci_Master_Data", "29", "", -1, "", true, false, true, "fa-database", "", false, true },
            new object[] { 3, "mi_mt_param", "3", "MtParamList", 29, "", "{74850334-D87A-4E71-B45A-50C64B48A90E}mt_param", false, false, "fa-cubes", "", false, true },
            new object[] { 4, "mi_mt_reason", "4", "MtReasonList", 29, "", "{74850334-D87A-4E71-B45A-50C64B48A90E}mt_reason", false, false, "fa-sheet-plastic", "", false, true },
            new object[] { 5, "mi_mt_template_email", "5", "MtTemplateEmailList", 29, "", "{74850334-D87A-4E71-B45A-50C64B48A90E}mt_template_email", false, false, "fa-envelopes-bulk", "", false, true },
            new object[] { 28, "mci_User", "28", "", -1, "", true, false, true, "fa-users", "", false, true },
            new object[] { 6, "mi_mt_user", "6", "MtUserList", 28, "", "{74850334-D87A-4E71-B45A-50C64B48A90E}mt_user", false, false, "fa-person", "", false, true },
            new object[] { 12, "mi_UserLevels", "12", "UserLevelsList", 28, "", "{74850334-D87A-4E71-B45A-50C64B48A90E}UserLevels", false, false, "fa-layer-group", "", false, true }
        };
        ...
        public static bool UseFixedHeaderTable = true;
