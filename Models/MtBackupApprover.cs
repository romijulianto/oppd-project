...
public partial class OverridePS {
    ...
    /// </summary>
    [MaybeNull]
    public static MtBackupApprover mtBackupApprover
    {
        get => HttpData.Resolve<MtBackupApprover>("mt_backup_approver");
        set => HttpData["mt_backup_approver"] = value;
    }

    /// <summary>
    /// Table class for mt_backup_approver
    /// </summary>
    public class MtBackupApprover : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> Position;

        public readonly DbField<SqlDbType> Departement;

        public readonly DbField<SqlDbType> Division;

        public readonly DbField<SqlDbType> Area;

        public readonly DbField<SqlDbType> Business_Area;

        public readonly DbField<SqlDbType> Report_To;

        public readonly DbField<SqlDbType> Business_Area_Desc;

        // Constructor
        public MtBackupApprover()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "mt_backup_approver";
            Name = "mt_backup_approver";
            Type = "TABLE";
            UpdateTable = "dbo.mt_backup_approver"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new (this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("mt_backup_approver", "id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("id", id);
            ...
            _UserName = new (this, "x__UserName", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("mt_backup_approver", "_UserName", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("UserName", _UserName);

            // Full_Name
            Full_Name = new (this, "x_Full_Name", 202, SqlDbType.NVarChar) {
                Name = "Full_Name",
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_backup_approver", "Full_Name", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Full_Name", Full_Name);

            // Position
            Position = new (this, "x_Position", 202, SqlDbType.NVarChar) {
                Name = "Position",
                Expression = "[Position]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Position]",
                DateTimeFormat = -1,
                VirtualExpression = "[Position]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_backup_approver", "Position", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Position", Position);

            // Departement
            Departement = new (this, "x_Departement", 202, SqlDbType.NVarChar) {
                Name = "Departement",
                Expression = "[Departement]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Departement]",
                DateTimeFormat = -1,
                VirtualExpression = "[Departement]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_backup_approver", "Departement", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Departement", Departement);

            // Division
            Division = new (this, "x_Division", 202, SqlDbType.NVarChar) {
                Name = "Division",
                Expression = "[Division]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Division]",
                DateTimeFormat = -1,
                VirtualExpression = "[Division]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_backup_approver", "Division", "CustomMsg"),
                IsUpload = false
            };
            ...
            Area = new (this, "x_Area", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_backup_approver", "Area", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Area", Area);

            // Business_Area
            Business_Area = new (this, "x_Business_Area", 202, SqlDbType.NVarChar) {
                Name = "Business_Area",
                Expression = "[Business_Area]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Business_Area]",
                DateTimeFormat = -1,
                VirtualExpression = "[Business_Area]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_backup_approver", "Business_Area", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Business_Area", Business_Area);

            // Report_To
            Report_To = new (this, "x_Report_To", 202, SqlDbType.NVarChar) {
                Name = "Report_To",
                Expression = "[Report_To]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Report_To]",
                DateTimeFormat = -1,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_backup_approver", "Report_To", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Report_To", Report_To);

            // Business_Area_Desc
            Business_Area_Desc = new (this, "x_Business_Area_Desc", 202, SqlDbType.NVarChar) {
                Name = "Business_Area_Desc",
                Expression = "[Business_Area_Desc]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Business_Area_Desc]",
                DateTimeFormat = -1,
                VirtualExpression = "[Business_Area_Desc]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_backup_approver", "Business_Area_Desc", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Business_Area_Desc", Business_Area_Desc);
        ...
        {
            get => _sqlFrom ?? "dbo.mt_backup_approver";
            set => _sqlFrom = value;
        }
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Position.DbValue = row["Position"]; // Set DB value only
                Departement.DbValue = row["Departement"]; // Set DB value only
                Division.DbValue = row["Division"]; // Set DB value only
                Area.DbValue = row["Area"]; // Set DB value only
                Business_Area.DbValue = row["Business_Area"]; // Set DB value only
                Report_To.DbValue = row["Report_To"]; // Set DB value only
                Business_Area_Desc.DbValue = row["Business_Area_Desc"]; // Set DB value only
            } catch {}
        }
        ...
        {
            if (SameString(pageName, "MtBackupApproverView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtBackupApproverEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtBackupApproverAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtBackupApproverView",
                Config.ApiAddAction => "MtBackupApproverAdd",
                Config.ApiEditAction => "MtBackupApproverEdit",
                Config.ApiDeleteAction => "MtBackupApproverDelete",
                Config.ApiListAction => "MtBackupApproverList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtBackupApproverList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtBackupApproverView", parm);
            else
                url = KeyUrl("MtBackupApproverView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtBackupApproverAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MtBackupApproverAdd?" + parm;
            else
                url = "MtBackupApproverAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtBackupApproverEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtBackupApproverList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtBackupApproverAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtBackupApproverList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtBackupApproverDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            Position.SetDbValue(dr["Position"]);
            Departement.SetDbValue(dr["Departement"]);
            Division.SetDbValue(dr["Division"]);
            Area.SetDbValue(dr["Area"]);
            Business_Area.SetDbValue(dr["Business_Area"]);
            Report_To.SetDbValue(dr["Report_To"]);
            Business_Area_Desc.SetDbValue(dr["Business_Area_Desc"]);
        }

        // Render list content
        public async Task<string> RenderListContent(string filter)
        {
            string pageName = "MtBackupApproverList";
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(Position);
                        doc.ExportCaption(Departement);
                        doc.ExportCaption(Division);
                        doc.ExportCaption(Area);
                        doc.ExportCaption(Business_Area);
                        doc.ExportCaption(Report_To);
                        doc.ExportCaption(Business_Area_Desc);
                    } else {
                        doc.ExportCaption(id);
                        doc.ExportCaption(_UserName);
                        doc.ExportCaption(Full_Name);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(Position);
                            await doc.ExportField(Departement);
                            await doc.ExportField(Division);
                            await doc.ExportField(Area);
                            await doc.ExportField(Business_Area);
                            await doc.ExportField(Report_To);
                            await doc.ExportField(Business_Area_Desc);
                        } else {
                            await doc.ExportField(id);
                            await doc.ExportField(_UserName);
                            await doc.ExportField(Full_Name);
