...
public partial class OverridePS {
    ...
    public class UserLevels : DbTable, IQueryFactory
    {
        ...
        public UserLevels()
        {
            ...
            UserLevelName.GetAutoUpdateValue = () => CurrentUserName();
        ...
        public async Task RenderListRow()
        {
            ...
            // UserLevelName
            UserLevelName.CellCssStyle = "min-width: 200px;";
        ...
        {
            UserLevelName.Count++; // Increment count
        }
        ...
        {
            UserLevelName.CurrentValue = UserLevelName.Count;
            UserLevelName.ViewValue = ConvertToString(UserLevelName.CurrentValue); // DN
            var _name = ResolveSecurity().GetUserLevelName(ConvertToString(UserLevelID.CurrentValue)); // DN
            if (!Empty(_name))
                UserLevelName.ViewValue = _name;
            UserLevelName.ViewCustomAttributes = "";
            UserLevelName.HrefValue = ""; // Clear href value
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (doc.Horizontal) {
                ...
                if (!doc.ExportCustom) {
                    ...
                    doc.ExportAggregate(UserLevelID, "");
                    doc.ExportAggregate(UserLevelName, "COUNT");
                    doc.EndExportRow();
                }
            }
            if (!doc.ExportCustom)
