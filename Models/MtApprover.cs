...
public partial class OverridePS {
    ...
    /// </summary>
    [MaybeNull]
    public static MtApprover mtApprover
    {
        get => HttpData.Resolve<MtApprover>("mt_approver");
        set => HttpData["mt_approver"] = value;
    }

    /// <summary>
    /// Table class for mt_approver
    /// </summary>
    public class MtApprover : DbTable, IQueryFactory
    {
        ...
        public MtApprover()
        {
            ...
            Name = "mt_approver";
            Type = "TABLE";
            UpdateTable = "dbo.mt_approver"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new (this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("mt_approver", "id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("id", id);
            ...
            _UserName = new (this, "x__UserName", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("mt_approver", "_UserName", "CustomMsg"),
                IsUpload = false
            };
            ...
            Full_Name = new (this, "x_Full_Name", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_approver", "Full_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            Position = new (this, "x_Position", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_approver", "Position", "CustomMsg"),
                IsUpload = false
            };
            ...
            Departement = new (this, "x_Departement", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_approver", "Departement", "CustomMsg"),
                IsUpload = false
            };
            ...
            Division = new (this, "x_Division", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_approver", "Division", "CustomMsg"),
                IsUpload = false
            };
            ...
            Area = new (this, "x_Area", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_approver", "Area", "CustomMsg"),
                IsUpload = false
            };
            ...
            Business_Area = new (this, "x_Business_Area", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_approver", "Business_Area", "CustomMsg"),
                IsUpload = false
            };
            ...
            Business_Area_Desc = new (this, "x_Business_Area_Desc", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_approver", "Business_Area_Desc", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            if (SameString(pageName, "MtApproverView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtApproverEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtApproverAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtApproverView",
                Config.ApiAddAction => "MtApproverAdd",
                Config.ApiEditAction => "MtApproverEdit",
                Config.ApiDeleteAction => "MtApproverDelete",
                Config.ApiListAction => "MtApproverList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtApproverList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtApproverView", parm);
            else
                url = KeyUrl("MtApproverView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtApproverAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtApproverEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtApproverList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtApproverAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtApproverList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtApproverDelete")); // DN
        ...
        {
            string pageName = "MtApproverList";
