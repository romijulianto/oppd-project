...
public partial class OverridePS {
    ...
    /// mtApproverView
    /// </summary>
    public static MtApproverView mtApproverView
    {
        get => HttpData.Get<MtApproverView>("mtApproverView")!;
        set => HttpData["mtApproverView"] = value;
    }

    /// <summary>
    /// Page class for mt_approver
    /// </summary>
    public class MtApproverView : MtApproverViewBase
    {
        // Constructor
        public MtApproverView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtApproverView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtApproverViewBase : MtApprover
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtApproverView";
        ...
        // Page name
        public string PageName => "MtApproverView";
        ...
        // Constructor
        public MtApproverViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtApproverList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtApproverList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fmt_approverview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
