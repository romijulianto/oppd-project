...
public partial class OverridePS {
    ...
    /// mtApproverDelete
    /// </summary>
    public static MtApproverDelete mtApproverDelete
    {
        get => HttpData.Get<MtApproverDelete>("mtApproverDelete")!;
        set => HttpData["mtApproverDelete"] = value;
    }

    /// <summary>
    /// Page class for mt_approver
    /// </summary>
    public class MtApproverDelete : MtApproverDeleteBase
    {
        // Constructor
        public MtApproverDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtApproverDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtApproverDeleteBase : MtApprover
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtApproverDelete";
        ...
        // Page name
        public string PageName => "MtApproverDelete";
        ...
        // Constructor
        public MtApproverDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtApproverList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtApproverList"); // Return to list
                }
            }
