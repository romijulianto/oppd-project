...
public partial class OverridePS {
    ...
    /// </summary>
    [MaybeNull]
    public static MtParam mtParam
    {
        get => HttpData.Resolve<MtParam>("mt_param");
        set => HttpData["mt_param"] = value;
    }

    /// <summary>
    /// Table class for mt_param
    /// </summary>
    public class MtParam : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> Param_Type;

        public readonly DbField<SqlDbType> Param_Name;

        public readonly DbField<SqlDbType> Param_Value;

        public readonly DbField<SqlDbType> Param_Status;
        ...
        public MtParam()
        {
            ...
            Name = "mt_param";
            Type = "TABLE";
            UpdateTable = "dbo.mt_param"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new (this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("mt_param", "id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("id", id);

            // Param_Type
            Param_Type = new (this, "x_Param_Type", 202, SqlDbType.NVarChar) {
                Name = "Param_Type",
                Expression = "[Param_Type]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Param_Type]",
                DateTimeFormat = -1,
                VirtualExpression = "[Param_Type]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("mt_param", "Param_Type", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Param_Type", Param_Type);

            // Param_Name
            Param_Name = new (this, "x_Param_Name", 202, SqlDbType.NVarChar) {
                Name = "Param_Name",
                Expression = "[Param_Name]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Param_Name]",
                DateTimeFormat = -1,
                VirtualExpression = "[Param_Name]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_param", "Param_Name", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Param_Name", Param_Name);

            // Param_Value
            Param_Value = new (this, "x_Param_Value", 202, SqlDbType.NVarChar) {
                Name = "Param_Value",
                Expression = "[Param_Value]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Param_Value]",
                DateTimeFormat = -1,
                VirtualExpression = "[Param_Value]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_param", "Param_Value", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Param_Value", Param_Value);

            // Param_Status
            Param_Status = new (this, "x_Param_Status", 202, SqlDbType.NVarChar) {
                Name = "Param_Status",
                Expression = "[Param_Status]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Param_Status]",
                DateTimeFormat = -1,
                VirtualExpression = "[Param_Status]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("mt_param", "Param_Status", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Param_Status", Param_Status);
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Param_Type.DbValue = row["Param_Type"]; // Set DB value only
                Param_Name.DbValue = row["Param_Name"]; // Set DB value only
                Param_Value.DbValue = row["Param_Value"]; // Set DB value only
                Param_Status.DbValue = row["Param_Status"]; // Set DB value only
            } catch {}
        }
        ...
        {
            if (SameString(pageName, "MtParamView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "MtParamEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "MtParamAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MtParamView",
                Config.ApiAddAction => "MtParamAdd",
                Config.ApiEditAction => "MtParamEdit",
                Config.ApiDeleteAction => "MtParamDelete",
                Config.ApiListAction => "MtParamList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MtParamList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MtParamView", parm);
            else
                url = KeyUrl("MtParamView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MtParamAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MtParamEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtParamList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MtParamAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MtParamList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("MtParamDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            if (dr == null)
                return;
            id.SetDbValue(dr["id"]);
            Param_Type.SetDbValue(dr["Param_Type"]);
            Param_Name.SetDbValue(dr["Param_Name"]);
            Param_Value.SetDbValue(dr["Param_Value"]);
            Param_Status.SetDbValue(dr["Param_Status"]);
        }

        // Render list content
        public async Task<string> RenderListContent(string filter)
        {
            string pageName = "MtParamList";
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(Param_Type);
                        doc.ExportCaption(Param_Name);
                        doc.ExportCaption(Param_Value);
                        doc.ExportCaption(Param_Status);
                    } else {
                        doc.ExportCaption(id);
                        doc.ExportCaption(Param_Type);
                        doc.ExportCaption(Param_Name);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(Param_Type);
                            await doc.ExportField(Param_Name);
                            await doc.ExportField(Param_Value);
                            await doc.ExportField(Param_Status);
                        } else {
                            await doc.ExportField(id);
                            await doc.ExportField(Param_Type);
                            await doc.ExportField(Param_Name);
