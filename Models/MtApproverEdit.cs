...
public partial class OverridePS {
    ...
    /// mtApproverEdit
    /// </summary>
    public static MtApproverEdit mtApproverEdit
    {
        get => HttpData.Get<MtApproverEdit>("mtApproverEdit")!;
        set => HttpData["mtApproverEdit"] = value;
    }

    /// <summary>
    /// Page class for mt_approver
    /// </summary>
    public class MtApproverEdit : MtApproverEditBase
    {
        // Constructor
        public MtApproverEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtApproverEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtApproverEditBase : MtApprover
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtApproverEdit";
        ...
        // Page name
        public string PageName => "MtApproverEdit";
        ...
        // Constructor
        public MtApproverEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("MtApproverList"); // No matching record, return to list
                        }
                    break;
