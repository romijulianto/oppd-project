...
public partial class OverridePS {
    /// <summary>
    /// trRequestApproverList
    /// </summary>
    public static TrRequestApproverList trRequestApproverList
    {
        get => HttpData.Get<TrRequestApproverList>("trRequestApproverList")!;
        set => HttpData["trRequestApproverList"] = value;
    }

    /// <summary>
    /// Page class for tr_request_approver
    /// </summary>
    public class TrRequestApproverList : TrRequestApproverListBase
    {
        // Constructor
        public TrRequestApproverList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TrRequestApproverList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TrRequestApproverListBase : TrRequestApprover
    {
        // Page ID
        ...
        // Table name
        public string TableName { get; set; } = "tr_request_approver";

        // Page object name
        public string PageObjName = "trRequestApproverList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "ftr_request_approverlist";
        ...
        // Constructor
        public TrRequestApproverListBase()
        {
            ...
            // Table object (trRequestApprover)
            if (trRequestApprover == null || trRequestApprover is TrRequestApprover)
                trRequestApprover = this;

            // Initialize URLs
            AddUrl = "TrRequestApproverAdd";
            ...
            MultiDeleteUrl = "TrRequestApproverDelete";
            MultiUpdateUrl = "TrRequestApproverUpdate";
        ...
        // Page name
        public string PageName => "TrRequestApproverList";
        ...
        // Constructor
        public TrRequestApproverListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                if (Response != null && !Response.HasStarted) {
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        if (pageName != ListUrl) { // Not List page
                            ...
                            result.Add("view", pageName == "TrRequestApproverView" ? "1" : "0"); // If View page, no primary button
                        } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "ftr_request_approvergrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                trRequestApproverList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task<string> GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(Approval_Status.AdvancedSearch.ToJson())); // Field Approval_Status
        ...
        protected bool RestoreFilterList() {
            ...
            if (filter?.TryGetValue("x_Approval_Status", out sv) ?? false) {
                Approval_Status.AdvancedSearch.SearchValue = sv;
                Approval_Status.AdvancedSearch.SearchOperator = filter["z_Approval_Status"];
                Approval_Status.AdvancedSearch.SearchCondition = filter["v_Approval_Status"];
                Approval_Status.AdvancedSearch.SearchValue2 = filter["y_Approval_Status"];
                Approval_Status.AdvancedSearch.SearchOperator2 = filter["w_Approval_Status"];
                Approval_Status.AdvancedSearch.Save();
            }
        ...
        public string AdvancedSearchWhere(bool def = false) {
            ...
            BuildSearchSql(ref where, Approval_Status, def, true); // Approval_Status
            ...
            if (!def && Command == "search") {
                ...
                Approval_Status.AdvancedSearch.Save(); // Approval_Status
        ...
        public void ShowFilterList()
        {
            ...
            // Field Approval_Status
            filter = QueryBuilderWhere("Approval_Status");
            if (Empty(filter))
                BuildSearchSql(ref filter, Approval_Status, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + Approval_Status.Caption + "</span>" + captionSuffix + filter + "</div>";
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(Approval_Status);
        ...
        protected bool CheckSearchParms() {
            ...
            if (Position_Name.AdvancedSearch.IssetSession)
                return true;
            if (Approval_Status.AdvancedSearch.IssetSession)
                return true;
        ...
        protected void ResetAdvancedSearchParms() {
            ...
            Approval_Status.AdvancedSearch.UnsetSession();
        ...
        protected void RestoreSearchParms() {
            ...
            Approval_Status.AdvancedSearch.Load();
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(Approval_Status); // Approval_Status
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""tr_request_approver"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"ftr_request_approverlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"ftr_request_approverlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("Approval_Status")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"ftr_request_approversrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"ftr_request_approversrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"ftr_request_approverlist\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_tr_request_approver");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(trRequestApproverList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(trRequestApproverList.RowCount) + "_tr_request_approver");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(trRequestApproverList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && trRequestApproverList.RowType == RowType.Add || IsEdit && trRequestApproverList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void LoadSearchValues() {
            ...
            // Approval_Status
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_Approval_Status[]"))
                    Approval_Status.AdvancedSearch.SearchValue = Get("x_Approval_Status[]");
                else
                    Approval_Status.AdvancedSearch.SearchValue = Get("Approval_Status"); // Default Value // DN
            if (!Empty(Approval_Status.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_Approval_Status"))
                Approval_Status.AdvancedSearch.SearchOperator = Get("z_Approval_Status");
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            Approval_Status.SetDbValue(row["Approval_Status"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("Approval_Status", Approval_Status.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // Approval_Status
                if (Approval_Status.UseFilter && !Empty(Approval_Status.AdvancedSearch.SearchValue)) {
                    Approval_Status.EditValue = ConvertToString(Approval_Status.AdvancedSearch.SearchValue).Split(Config.MultipleOptionSeparator).ToList();
                }
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"ftr_request_approversrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
