...
public partial class OverridePS {
    ...
    /// </summary>
    [MaybeNull]
    public static VTrRequest vTrRequest
    {
        get => HttpData.Resolve<VTrRequest>("v_tr_request");
        set => HttpData["v_tr_request"] = value;
    }

    /// <summary>
    /// Table class for v_tr_request
    /// </summary>
    public class VTrRequest : DbTable, IQueryFactory
    {
        ...
        public VTrRequest()
        {
            ...
            Name = "v_tr_request";
            Type = "VIEW";
            UpdateTable = "[OverridePS].[dbo].[tr_request]"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new (this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("v_tr_request", "id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("id", id);
            ...
            Request_No = new (this, "x_Request_No", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("v_tr_request", "Request_No", "CustomMsg"),
                IsUpload = false
            };
            ...
            Reference_Doc = new (this, "x_Reference_Doc", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Reference_Doc", "CustomMsg"),
                IsUpload = false
            };
            ...
            Reason = new (this, "x_Reason", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Reason", "CustomMsg"),
                IsUpload = false
            };
            ...
            Request_By = new (this, "x_Request_By", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Request_By", "CustomMsg"),
                IsUpload = false
            };
            ...
            Request_By_Name = new (this, "x_Request_By_Name", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Request_By_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            Request_By_Position = new (this, "x_Request_By_Position", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Request_By_Position", "CustomMsg"),
                IsUpload = false
            };
            ...
            Request_By_Branch = new (this, "x_Request_By_Branch", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Request_By_Branch", "CustomMsg"),
                IsUpload = false
            };
            ...
            Request_By_Region = new (this, "x_Request_By_Region", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Request_By_Region", "CustomMsg"),
                IsUpload = false
            };
            ...
            Request_Industry = new (this, "x_Request_Industry", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Request_Industry", "CustomMsg"),
                IsUpload = false
            };
            ...
            Customer_ID = new (this, "x_Customer_ID", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Customer_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            Customer_Name = new (this, "x_Customer_Name", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Customer_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            SAP_Total = new (this, "x_SAP_Total", 5, SqlDbType.Float) {
                ...
                CustomMessage = Language.FieldPhrase("v_tr_request", "SAP_Total", "CustomMsg"),
                IsUpload = false
            };
            ...
            Override_Total = new (this, "x_Override_Total", 5, SqlDbType.Float) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Override_Total", "CustomMsg"),
                IsUpload = false
            };
            ...
            Variance_Total = new (this, "x_Variance_Total", 5, SqlDbType.Float) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Variance_Total", "CustomMsg"),
                IsUpload = false
            };
            ...
            Variance_Percent = new (this, "x_Variance_Percent", 5, SqlDbType.Float) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Variance_Percent", "CustomMsg"),
                IsUpload = false
            };
            ...
            Notes = new (this, "x_Notes", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Notes", "CustomMsg"),
                IsUpload = false
            };
            ...
            Next_Approver = new (this, "x_Next_Approver", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Next_Approver", "CustomMsg"),
                IsUpload = false
            };
            ...
            List_Approver = new (this, "x_List_Approver", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "List_Approver", "CustomMsg"),
                IsUpload = false
            };
            ...
            Last_Update_By = new (this, "x_Last_Update_By", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Last_Update_By", "CustomMsg"),
                IsUpload = false
            };
            ...
            Created_By = new (this, "x_Created_By", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Created_By", "CustomMsg"),
                IsUpload = false
            };
            ...
            Created_Date = new (this, "x_Created_Date", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Created_Date", "CustomMsg"),
                IsUpload = false
            };
            ...
            ETL_Date = new (this, "x_ETL_Date", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "ETL_Date", "CustomMsg"),
                IsUpload = false
            };
            ...
            Request_Status = new (this, "x_Request_Status", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Request_Status", "CustomMsg"),
                IsUpload = false
            };
            ...
            Request_PIC = new (this, "x_Request_PIC", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("v_tr_request", "Request_PIC", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            if (SameString(pageName, "VTrRequestView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "VTrRequestEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "VTrRequestAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "VTrRequestView",
                Config.ApiAddAction => "VTrRequestAdd",
                Config.ApiEditAction => "VTrRequestEdit",
                Config.ApiDeleteAction => "VTrRequestDelete",
                Config.ApiListAction => "VTrRequestList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "VTrRequestList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("VTrRequestView", parm);
            else
                url = KeyUrl("VTrRequestView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "VTrRequestAdd";
        ...
        public string GetEditUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("VTrRequestEdit", parm);
            else
                url = KeyUrl("VTrRequestEdit", Config.TableShowDetail + "=");
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("VTrRequestList", "action=edit"))); // DN
        ...
        public string GetCopyUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("VTrRequestAdd", parm);
            else
                url = KeyUrl("VTrRequestAdd", Config.TableShowDetail + "=");
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("VTrRequestList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("VTrRequestDelete")); // DN
        ...
        {
            string pageName = "VTrRequestList";
        ...
        public async Task RenderEditRow()
        {
            ...
            if (!Request_By.Raw)
                Request_By.CurrentValue = HtmlDecode(Request_By.CurrentValue);
            Request_By.EditValue = HtmlEncode(Request_By.CurrentValue);
            Request_By.PlaceHolder = RemoveHtml(Request_By.Caption);

            // Request_By_Name
            Request_By_Name.SetupEditAttributes();
            if (!Request_By_Name.Raw)
                Request_By_Name.CurrentValue = HtmlDecode(Request_By_Name.CurrentValue);
            Request_By_Name.EditValue = HtmlEncode(Request_By_Name.CurrentValue);
            ...
            if (!Request_By_Position.Raw)
                Request_By_Position.CurrentValue = HtmlDecode(Request_By_Position.CurrentValue);
            Request_By_Position.EditValue = HtmlEncode(Request_By_Position.CurrentValue);
            ...
            if (!Notes.Raw)
                Notes.CurrentValue = HtmlDecode(Notes.CurrentValue);
            Notes.EditValue = HtmlEncode(Notes.CurrentValue);
            ...
            if (!Request_Status.Raw)
                Request_Status.CurrentValue = HtmlDecode(Request_Status.CurrentValue);
            Request_Status.EditValue = HtmlEncode(Request_Status.CurrentValue);
