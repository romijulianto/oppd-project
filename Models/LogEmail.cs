...
public partial class OverridePS {
    ...
    /// </summary>
    [MaybeNull]
    public static LogEmail logEmail
    {
        get => HttpData.Resolve<LogEmail>("log_email");
        set => HttpData["log_email"] = value;
    }

    /// <summary>
    /// Table class for log_email
    /// </summary>
    public class LogEmail : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> Email_Type;

        public readonly DbField<SqlDbType> Email_To;

        public readonly DbField<SqlDbType> Email_Cc;

        public readonly DbField<SqlDbType> Email_Subject;

        public readonly DbField<SqlDbType> Email_Body;
        ...
        public LogEmail()
        {
            ...
            Name = "log_email";
            Type = "TABLE";
            UpdateTable = "dbo.log_email"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new (this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("log_email", "id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("id", id);

            // Email_Type
            Email_Type = new (this, "x_Email_Type", 200, SqlDbType.VarChar) {
                Name = "Email_Type",
                Expression = "[Email_Type]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Email_Type]",
                DateTimeFormat = -1,
                VirtualExpression = "[Email_Type]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("log_email", "Email_Type", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Email_Type", Email_Type);

            // Email_To
            Email_To = new (this, "x_Email_To", 200, SqlDbType.VarChar) {
                Name = "Email_To",
                Expression = "[Email_To]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Email_To]",
                DateTimeFormat = -1,
                VirtualExpression = "[Email_To]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("log_email", "Email_To", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Email_To", Email_To);

            // Email_Cc
            Email_Cc = new (this, "x_Email_Cc", 200, SqlDbType.VarChar) {
                Name = "Email_Cc",
                Expression = "[Email_Cc]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Email_Cc]",
                DateTimeFormat = -1,
                VirtualExpression = "[Email_Cc]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("log_email", "Email_Cc", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Email_Cc", Email_Cc);

            // Email_Subject
            Email_Subject = new (this, "x_Email_Subject", 200, SqlDbType.VarChar) {
                Name = "Email_Subject",
                Expression = "[Email_Subject]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Email_Subject]",
                DateTimeFormat = -1,
                VirtualExpression = "[Email_Subject]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("log_email", "Email_Subject", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Email_Subject", Email_Subject);

            // Email_Body
            Email_Body = new (this, "x_Email_Body", 200, SqlDbType.VarChar) {
                Name = "Email_Body",
                Expression = "[Email_Body]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Email_Body]",
                DateTimeFormat = -1,
                VirtualExpression = "[Email_Body]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("log_email", "Email_Body", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Email_Body", Email_Body);
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Email_Type.DbValue = row["Email_Type"]; // Set DB value only
                Email_To.DbValue = row["Email_To"]; // Set DB value only
                Email_Cc.DbValue = row["Email_Cc"]; // Set DB value only
                Email_Subject.DbValue = row["Email_Subject"]; // Set DB value only
                Email_Body.DbValue = row["Email_Body"]; // Set DB value only
            } catch {}
        }
        ...
        {
            if (SameString(pageName, "LogEmailView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "LogEmailEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "LogEmailAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "LogEmailView",
                Config.ApiAddAction => "LogEmailAdd",
                Config.ApiEditAction => "LogEmailEdit",
                Config.ApiDeleteAction => "LogEmailDelete",
                Config.ApiListAction => "LogEmailList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "LogEmailList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("LogEmailView", parm);
            else
                url = KeyUrl("LogEmailView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "LogEmailAdd";
        ...
        {
            string url = "";
            url = KeyUrl("LogEmailEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("LogEmailList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("LogEmailAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("LogEmailList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("LogEmailDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            if (dr == null)
                return;
            id.SetDbValue(dr["id"]);
            Email_Type.SetDbValue(dr["Email_Type"]);
            Email_To.SetDbValue(dr["Email_To"]);
            Email_Cc.SetDbValue(dr["Email_Cc"]);
            Email_Subject.SetDbValue(dr["Email_Subject"]);
            Email_Body.SetDbValue(dr["Email_Body"]);
        }

        // Render list content
        public async Task<string> RenderListContent(string filter)
        {
            string pageName = "LogEmailList";
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(Email_Type);
                        doc.ExportCaption(Email_To);
                        doc.ExportCaption(Email_Cc);
                        doc.ExportCaption(Email_Subject);
                        doc.ExportCaption(Email_Body);
                    } else {
                        doc.ExportCaption(id);
                        doc.ExportCaption(Email_Type);
                        doc.ExportCaption(Email_To);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(Email_Type);
                            await doc.ExportField(Email_To);
                            await doc.ExportField(Email_Cc);
                            await doc.ExportField(Email_Subject);
                            await doc.ExportField(Email_Body);
                        } else {
                            await doc.ExportField(id);
                            await doc.ExportField(Email_Type);
                            await doc.ExportField(Email_To);
