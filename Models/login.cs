...
public partial class OverridePS {
    ...
    public class LoginBase : MtUser
    {
        ...
        public DbField<SqlDbType> LoginUsername = new ("mt_user", "username", 202, SqlDbType.NVarChar) {
                TableName = "mt_user",
                Name = "username",
                Expression = "username"
            }; // DN

        public DbField<SqlDbType> LoginPassword = new ("mt_user", "password", 202, SqlDbType.NVarChar) {
                TableName = "mt_user",
                Name = "password",
                Expression = "password"
            }; // DN

        public DbField<SqlDbType> LoginType = new ("mt_user", "type", 202, SqlDbType.NVarChar) {
                TableName = "mt_user",
                Name = "logintype",
