...
public partial class OverridePS {
    ...
    /// mtParamView
    /// </summary>
    public static MtParamView mtParamView
    {
        get => HttpData.Get<MtParamView>("mtParamView")!;
        set => HttpData["mtParamView"] = value;
    }

    /// <summary>
    /// Page class for mt_param
    /// </summary>
    public class MtParamView : MtParamViewBase
    {
        // Constructor
        public MtParamView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtParamView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtParamViewBase : MtParam
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtParamView";
        ...
        // Page name
        public string PageName => "MtParamView";
        ...
        // Constructor
        public MtParamViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtParamList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtParamList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fmt_paramview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
