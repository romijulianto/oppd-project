...
public partial class OverridePS {
    ...
    /// logApiDelete
    /// </summary>
    public static LogApiDelete logApiDelete
    {
        get => HttpData.Get<LogApiDelete>("logApiDelete")!;
        set => HttpData["logApiDelete"] = value;
    }

    /// <summary>
    /// Page class for log_API
    /// </summary>
    public class LogApiDelete : LogApiDeleteBase
    {
        // Constructor
        public LogApiDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public LogApiDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class LogApiDeleteBase : LogApi
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "logApiDelete";
        ...
        // Page name
        public string PageName => "LogApiDelete";
        ...
        // Constructor
        public LogApiDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("LogApiList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("LogApiList"); // Return to list
                }
            }
