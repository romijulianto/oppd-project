...
public partial class OverridePS {
    ...
    /// trRequestSearch
    /// </summary>
    public static TrRequestSearch trRequestSearch
    {
        get => HttpData.Get<TrRequestSearch>("trRequestSearch")!;
        set => HttpData["trRequestSearch"] = value;
    }

    /// <summary>
    /// Page class for tr_request
    /// </summary>
    public class TrRequestSearch : TrRequestSearchBase
    {
        // Constructor
        public TrRequestSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TrRequestSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TrRequestSearchBase : TrRequest
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "trRequestSearch";
        ...
        // Page name
        public string PageName => "TrRequestSearch";
        ...
        // Constructor
        public TrRequestSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        protected string BuildAdvancedSearch() {
            ...
            BuildSearchUrl(ref srchUrl, Request_Currency); // Request_Currency
            if (!Empty(srchUrl))
                srchUrl += "&";
            srchUrl += "cmd=search";
            return srchUrl;
        ...
        protected void LoadSearchValues() {
            ...
            if (Form.ContainsKey("v_id"))
                id.AdvancedSearch.SearchCondition = CurrentForm.GetValue("v_id");
            if (Form.ContainsKey("y_id"))
                id.AdvancedSearch.SearchValue2 = CurrentForm.GetValue("y_id");
            if (Form.ContainsKey("w_id"))
                id.AdvancedSearch.SearchOperator2 = CurrentForm.GetValue("w_id");
            ...
            // Request_Currency
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_Request_Currency"))
                    Request_Currency.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_Request_Currency");
            if (Form.ContainsKey("z_Request_Currency"))
                Request_Currency.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_Request_Currency");
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                id.SetupEditAttributes();
                id.EditValue2 = id.AdvancedSearch.SearchValue2; // DN
                id.PlaceHolder = RemoveHtml(id.Caption);
                ...
                curVal = ConvertToString(Reason.AdvancedSearch.SearchValue)?.Trim() ?? "";
                if (Reason.Lookup != null && IsDictionary(Reason.Lookup?.Options) && Reason.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    ...
                    if (curVal == "") {
                        ...
                        filterWrk = SearchFilter("[Reason_Type]", "=", Reason.AdvancedSearch.SearchValue, DataType.String, "");
                    }
                ...
                Notes.EditValue = Notes.AdvancedSearch.SearchValue; // DN
        ...
        protected bool ValidateSearch() {
            ...
            if (!CheckInteger(ConvertToString(id.AdvancedSearch.SearchValue2))) {
                id.AddErrorMessage(id.GetErrorMessage(false));
            }
