...
public partial class OverridePS {
    ...
    /// mtReasonDelete
    /// </summary>
    public static MtReasonDelete mtReasonDelete
    {
        get => HttpData.Get<MtReasonDelete>("mtReasonDelete")!;
        set => HttpData["mtReasonDelete"] = value;
    }

    /// <summary>
    /// Page class for mt_reason
    /// </summary>
    public class MtReasonDelete : MtReasonDeleteBase
    {
        // Constructor
        public MtReasonDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtReasonDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtReasonDeleteBase : MtReason
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtReasonDelete";
        ...
        // Page name
        public string PageName => "MtReasonDelete";
        ...
        // Constructor
        public MtReasonDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtReasonList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtReasonList"); // Return to list
                }
            }
