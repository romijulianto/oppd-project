...
public partial class OverridePS {
    ...
    /// logEmailDelete
    /// </summary>
    public static LogEmailDelete logEmailDelete
    {
        get => HttpData.Get<LogEmailDelete>("logEmailDelete")!;
        set => HttpData["logEmailDelete"] = value;
    }

    /// <summary>
    /// Page class for log_email
    /// </summary>
    public class LogEmailDelete : LogEmailDeleteBase
    {
        // Constructor
        public LogEmailDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public LogEmailDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class LogEmailDeleteBase : LogEmail
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "logEmailDelete";
        ...
        // Page name
        public string PageName => "LogEmailDelete";
        ...
        // Constructor
        public LogEmailDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("LogEmailList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("LogEmailList"); // Return to list
                }
            }
