...
public partial class OverridePS {
    ...
    /// mtParamDelete
    /// </summary>
    public static MtParamDelete mtParamDelete
    {
        get => HttpData.Get<MtParamDelete>("mtParamDelete")!;
        set => HttpData["mtParamDelete"] = value;
    }

    /// <summary>
    /// Page class for mt_param
    /// </summary>
    public class MtParamDelete : MtParamDeleteBase
    {
        // Constructor
        public MtParamDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtParamDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtParamDeleteBase : MtParam
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtParamDelete";
        ...
        // Page name
        public string PageName => "MtParamDelete";
        ...
        // Constructor
        public MtParamDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MtParamList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MtParamList"); // Return to list
                }
            }
