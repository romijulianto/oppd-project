...
public partial class OverridePS {
    ...
    public static object? Invoke(string name, object?[]? parameters = null) =>
        typeof(OverridePS).GetMethod(name)?.Invoke(null, parameters);
    ...
    public static object? GetPropertyValue(string name) =>
        typeof(OverridePS).GetProperty(name, BindingFlags.Public | BindingFlags.Static | BindingFlags.FlattenHierarchy | BindingFlags.Instance)?.GetValue(null);
    ...
    // User Table
    public static MtUser UserTable
    {
        get => HttpData.Get<MtUser>("USER_TABLE")!;
