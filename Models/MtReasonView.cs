...
public partial class OverridePS {
    ...
    /// mtReasonView
    /// </summary>
    public static MtReasonView mtReasonView
    {
        get => HttpData.Get<MtReasonView>("mtReasonView")!;
        set => HttpData["mtReasonView"] = value;
    }

    /// <summary>
    /// Page class for mt_reason
    /// </summary>
    public class MtReasonView : MtReasonViewBase
    {
        // Constructor
        public MtReasonView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtReasonView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtReasonViewBase : MtReason
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtReasonView";
        ...
        // Page name
        public string PageName => "MtReasonView";
        ...
        // Constructor
        public MtReasonViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtReasonList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtReasonList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fmt_reasonview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
