...
public partial class OverridePS {
    ...
    {
        get => HttpData.Resolve<LogApi>("log_API");
        set => HttpData["log_API"] = value;
    }

    /// <summary>
    /// Table class for log_API
    /// </summary>
    public class LogApi : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> API_Type;

        public readonly DbField<SqlDbType> API_Link;

        public readonly DbField<SqlDbType> API_Body;

        public readonly DbField<SqlDbType> API_Status;

        public readonly DbField<SqlDbType> API_Result;
        ...
        public LogApi()
        {
            ...
            Name = "log_API";
            Type = "TABLE";
            UpdateTable = "dbo.log_API"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new (this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("log_API", "id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("id", id);

            // API_Type
            API_Type = new (this, "x_API_Type", 202, SqlDbType.NVarChar) {
                Name = "API_Type",
                Expression = "[API_Type]",
                UseBasicSearch = true,
                BasicSearchExpression = "[API_Type]",
                DateTimeFormat = -1,
                VirtualExpression = "[API_Type]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("log_API", "API_Type", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("API_Type", API_Type);

            // API_Link
            API_Link = new (this, "x_API_Link", 202, SqlDbType.NVarChar) {
                Name = "API_Link",
                Expression = "[API_Link]",
                UseBasicSearch = true,
                BasicSearchExpression = "[API_Link]",
                DateTimeFormat = -1,
                VirtualExpression = "[API_Link]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("log_API", "API_Link", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("API_Link", API_Link);

            // API_Body
            API_Body = new (this, "x_API_Body", 202, SqlDbType.NVarChar) {
                Name = "API_Body",
                Expression = "[API_Body]",
                UseBasicSearch = true,
                BasicSearchExpression = "[API_Body]",
                DateTimeFormat = -1,
                VirtualExpression = "[API_Body]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("log_API", "API_Body", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("API_Body", API_Body);

            // API_Status
            API_Status = new (this, "x_API_Status", 202, SqlDbType.NVarChar) {
                Name = "API_Status",
                Expression = "[API_Status]",
                UseBasicSearch = true,
                BasicSearchExpression = "[API_Status]",
                DateTimeFormat = -1,
                VirtualExpression = "[API_Status]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("log_API", "API_Status", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("API_Status", API_Status);

            // API_Result
            API_Result = new (this, "x_API_Result", 202, SqlDbType.NVarChar) {
                Name = "API_Result",
                Expression = "[API_Result]",
                UseBasicSearch = true,
                BasicSearchExpression = "[API_Result]",
                DateTimeFormat = -1,
                VirtualExpression = "[API_Result]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("log_API", "API_Result", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("API_Result", API_Result);
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                API_Type.DbValue = row["API_Type"]; // Set DB value only
                API_Link.DbValue = row["API_Link"]; // Set DB value only
                API_Body.DbValue = row["API_Body"]; // Set DB value only
                API_Status.DbValue = row["API_Status"]; // Set DB value only
                API_Result.DbValue = row["API_Result"]; // Set DB value only
            } catch {}
        }
        ...
        {
            if (SameString(pageName, "LogApiView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "LogApiEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "LogApiAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "LogApiView",
                Config.ApiAddAction => "LogApiAdd",
                Config.ApiEditAction => "LogApiEdit",
                Config.ApiDeleteAction => "LogApiDelete",
                Config.ApiListAction => "LogApiList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "LogApiList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("LogApiView", parm);
            else
                url = KeyUrl("LogApiView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "LogApiAdd";
        ...
        {
            string url = "";
            url = KeyUrl("LogApiEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("LogApiList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("LogApiAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("LogApiList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("LogApiDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            if (dr == null)
                return;
            id.SetDbValue(dr["id"]);
            API_Type.SetDbValue(dr["API_Type"]);
            API_Link.SetDbValue(dr["API_Link"]);
            API_Body.SetDbValue(dr["API_Body"]);
            API_Status.SetDbValue(dr["API_Status"]);
            API_Result.SetDbValue(dr["API_Result"]);
        }

        // Render list content
        public async Task<string> RenderListContent(string filter)
        {
            string pageName = "LogApiList";
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(API_Type);
                        doc.ExportCaption(API_Link);
                        doc.ExportCaption(API_Body);
                        doc.ExportCaption(API_Status);
                        doc.ExportCaption(API_Result);
                    } else {
                        doc.ExportCaption(id);
                        doc.ExportCaption(API_Type);
                        doc.ExportCaption(API_Link);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(API_Type);
                            await doc.ExportField(API_Link);
                            await doc.ExportField(API_Body);
                            await doc.ExportField(API_Status);
                            await doc.ExportField(API_Result);
                        } else {
                            await doc.ExportField(id);
                            await doc.ExportField(API_Type);
                            await doc.ExportField(API_Link);
