...
public partial class OverridePS {
    ...
    /// mtTemplateEmailView
    /// </summary>
    public static MtTemplateEmailView mtTemplateEmailView
    {
        get => HttpData.Get<MtTemplateEmailView>("mtTemplateEmailView")!;
        set => HttpData["mtTemplateEmailView"] = value;
    }

    /// <summary>
    /// Page class for mt_template_email
    /// </summary>
    public class MtTemplateEmailView : MtTemplateEmailViewBase
    {
        // Constructor
        public MtTemplateEmailView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtTemplateEmailView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtTemplateEmailViewBase : MtTemplateEmail
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtTemplateEmailView";
        ...
        // Constructor
        public MtTemplateEmailViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtTemplateEmailView";
        ...
        // Constructor
        public MtTemplateEmailViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtTemplateEmailList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtTemplateEmailList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtTemplateEmailView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fmt_template_emailview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
