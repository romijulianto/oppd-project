...
public partial class OverridePS {
    ...
    /// mtParamEdit
    /// </summary>
    public static MtParamEdit mtParamEdit
    {
        get => HttpData.Get<MtParamEdit>("mtParamEdit")!;
        set => HttpData["mtParamEdit"] = value;
    }

    /// <summary>
    /// Page class for mt_param
    /// </summary>
    public class MtParamEdit : MtParamEditBase
    {
        // Constructor
        public MtParamEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtParamEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtParamEditBase : MtParam
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtParamEdit";
        ...
        // Page name
        public string PageName => "MtParamEdit";
        ...
        // Constructor
        public MtParamEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("MtParamList"); // No matching record, return to list
                        }
                    break;
        ...
        protected async Task<JsonBoolResult> EditRow() { // DN
            ...
            // Param_Type
            Param_Type.SetDbValue(rsnew, Param_Type.CurrentValue, Param_Type.ReadOnly);

            // Param_Name
            Param_Name.SetDbValue(rsnew, Param_Name.CurrentValue, Param_Name.ReadOnly);

            // Param_Value
            Param_Value.SetDbValue(rsnew, Param_Value.CurrentValue, Param_Value.ReadOnly);

            // Param_Status
            Param_Status.SetDbValue(rsnew, Param_Status.CurrentValue, Param_Status.ReadOnly);
