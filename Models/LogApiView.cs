...
public partial class OverridePS {
    ...
    /// logApiView
    /// </summary>
    public static LogApiView logApiView
    {
        get => HttpData.Get<LogApiView>("logApiView")!;
        set => HttpData["logApiView"] = value;
    }

    /// <summary>
    /// Page class for log_API
    /// </summary>
    public class LogApiView : LogApiViewBase
    {
        // Constructor
        public LogApiView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public LogApiView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class LogApiViewBase : LogApi
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "logApiView";
        ...
        // Page name
        public string PageName => "LogApiView";
        ...
        // Constructor
        public LogApiViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "LogApiList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("LogApiList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"flog_APIview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
