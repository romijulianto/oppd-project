...
public partial class OverridePS {
    ...
    /// mtTemplateEmailList
    /// </summary>
    public static MtTemplateEmailList mtTemplateEmailList
    {
        get => HttpData.Get<MtTemplateEmailList>("mtTemplateEmailList")!;
        set => HttpData["mtTemplateEmailList"] = value;
    }

    /// <summary>
    /// Page class for mt_template_email
    /// </summary>
    public class MtTemplateEmailList : MtTemplateEmailListBase
    {
        // Constructor
        public MtTemplateEmailList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtTemplateEmailList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtTemplateEmailListBase : MtTemplateEmail
    {
        // Page ID
        ...
        // Table name
        public string TableName { get; set; } = "mt_template_email";

        // Page object name
        public string PageObjName = "mtTemplateEmailList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fmt_template_emaillist";
        ...
        // Constructor
        public MtTemplateEmailListBase()
        {
            // CSS class name as context
            TableVar = "mt_template_email";
            ...
            // Table object (mtTemplateEmail)
            if (mtTemplateEmail == null || mtTemplateEmail is MtTemplateEmail)
                mtTemplateEmail = this;

            // Initialize URLs
            AddUrl = "MtTemplateEmailAdd";
            ...
            MultiDeleteUrl = "MtTemplateEmailDelete";
            MultiUpdateUrl = "MtTemplateEmailUpdate";
        ...
        // Page name
        public string PageName => "MtTemplateEmailList";
        ...
        {
            id.SetVisibility();
            Template_Type.SetVisibility();
            Template_Name.SetVisibility();
            Template_Body.Visible = false;
            Template_Description.SetVisibility();
        }

        // Constructor
        public MtTemplateEmailListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                if (Response != null && !Response.HasStarted) {
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        if (pageName != ListUrl) { // Not List page
                            ...
                            result.Add("view", pageName == "MtTemplateEmailView" ? "1" : "0"); // If View page, no primary button
                        } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fmt_template_emailgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtTemplateEmailList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task<string> GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(Template_Type.AdvancedSearch.ToJson())); // Field Template_Type
            filters.Merge(JObject.Parse(Template_Name.AdvancedSearch.ToJson())); // Field Template_Name
            filters.Merge(JObject.Parse(Template_Body.AdvancedSearch.ToJson())); // Field Template_Body
            filters.Merge(JObject.Parse(Template_Description.AdvancedSearch.ToJson())); // Field Template_Description
        ...
        protected bool RestoreFilterList() {
            ...
            // Field Template_Type
            if (filter?.TryGetValue("x_Template_Type", out sv) ?? false) {
                Template_Type.AdvancedSearch.SearchValue = sv;
                Template_Type.AdvancedSearch.SearchOperator = filter["z_Template_Type"];
                Template_Type.AdvancedSearch.SearchCondition = filter["v_Template_Type"];
                Template_Type.AdvancedSearch.SearchValue2 = filter["y_Template_Type"];
                Template_Type.AdvancedSearch.SearchOperator2 = filter["w_Template_Type"];
                Template_Type.AdvancedSearch.Save();
            }

            // Field Template_Name
            if (filter?.TryGetValue("x_Template_Name", out sv) ?? false) {
                Template_Name.AdvancedSearch.SearchValue = sv;
                Template_Name.AdvancedSearch.SearchOperator = filter["z_Template_Name"];
                Template_Name.AdvancedSearch.SearchCondition = filter["v_Template_Name"];
                Template_Name.AdvancedSearch.SearchValue2 = filter["y_Template_Name"];
                Template_Name.AdvancedSearch.SearchOperator2 = filter["w_Template_Name"];
                Template_Name.AdvancedSearch.Save();
            }

            // Field Template_Body
            if (filter?.TryGetValue("x_Template_Body", out sv) ?? false) {
                Template_Body.AdvancedSearch.SearchValue = sv;
                Template_Body.AdvancedSearch.SearchOperator = filter["z_Template_Body"];
                Template_Body.AdvancedSearch.SearchCondition = filter["v_Template_Body"];
                Template_Body.AdvancedSearch.SearchValue2 = filter["y_Template_Body"];
                Template_Body.AdvancedSearch.SearchOperator2 = filter["w_Template_Body"];
                Template_Body.AdvancedSearch.Save();
            }

            // Field Template_Description
            if (filter?.TryGetValue("x_Template_Description", out sv) ?? false) {
                Template_Description.AdvancedSearch.SearchValue = sv;
                Template_Description.AdvancedSearch.SearchOperator = filter["z_Template_Description"];
                Template_Description.AdvancedSearch.SearchCondition = filter["v_Template_Description"];
                Template_Description.AdvancedSearch.SearchValue2 = filter["y_Template_Description"];
                Template_Description.AdvancedSearch.SearchOperator2 = filter["w_Template_Description"];
                Template_Description.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(Template_Type);
            searchFlds.Add(Template_Name);
            searchFlds.Add(Template_Body);
            searchFlds.Add(Template_Description);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(id); // id
                UpdateSort(Template_Type); // Template_Type
                UpdateSort(Template_Name); // Template_Name
                UpdateSort(Template_Description); // Template_Description
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""mt_template_email"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""mt_template_email"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalAdd && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-copy"" title=""{copycaption}"" data-table=""mt_template_email"" data-caption=""{copycaption}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(CopyUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("CopyLink") + "</a>");
                else
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fmt_template_emaillist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fmt_template_emaillist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""mt_template_email"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            item.Body = $@"<button type=""button"" class=""ew-action ew-multi-delete"" title=""{deleteTitle}"" data-caption=""{deleteTitle}"" form=""fmt_template_emaillist""" +
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("Template_Type")); // DN
                CreateColumnOption(option.Add("Template_Name")); // DN
                CreateColumnOption(option.Add("Template_Description")); // DN
            }
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fmt_template_emailsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fmt_template_emailsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fmt_template_emaillist\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_mt_template_email");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(mtTemplateEmailList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(mtTemplateEmailList.RowCount) + "_mt_template_email");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(mtTemplateEmailList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && mtTemplateEmailList.RowType == RowType.Add || IsEdit && mtTemplateEmailList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            Template_Type.SetDbValue(row["Template_Type"]);
            Template_Name.SetDbValue(row["Template_Name"]);
            Template_Body.SetDbValue(row["Template_Body"]);
            Template_Description.SetDbValue(row["Template_Description"]);
        }
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("Template_Type", Template_Type.DefaultValue ?? DbNullValue); // DN
            row.Add("Template_Name", Template_Name.DefaultValue ?? DbNullValue); // DN
            row.Add("Template_Body", Template_Body.DefaultValue ?? DbNullValue); // DN
            row.Add("Template_Description", Template_Description.DefaultValue ?? DbNullValue); // DN
            return row;
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // Template_Type
                Template_Type.ViewValue = ConvertToString(Template_Type.CurrentValue); // DN
                Template_Type.ViewCustomAttributes = "";

                // Template_Name
                Template_Name.ViewValue = ConvertToString(Template_Name.CurrentValue); // DN
                Template_Name.ViewCustomAttributes = "";

                // Template_Description
                Template_Description.ViewValue = ConvertToString(Template_Description.CurrentValue); // DN
                Template_Description.ViewCustomAttributes = "";
                ...
                // Template_Type
                Template_Type.HrefValue = "";
                Template_Type.TooltipValue = "";

                // Template_Name
                Template_Name.HrefValue = "";
                Template_Name.TooltipValue = "";

                // Template_Description
                Template_Description.HrefValue = "";
                Template_Description.TooltipValue = "";
            }
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fmt_template_emailsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
