...
public partial class OverridePS {
    ...
    /// vTrRequestView
    /// </summary>
    public static VTrRequestView vTrRequestView
    {
        get => HttpData.Get<VTrRequestView>("vTrRequestView")!;
        set => HttpData["vTrRequestView"] = value;
    }

    /// <summary>
    /// Page class for v_tr_request
    /// </summary>
    public class VTrRequestView : VTrRequestViewBase
    {
        // Constructor
        public VTrRequestView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VTrRequestView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VTrRequestViewBase : VTrRequest
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vTrRequestView";
        ...
        // Page name
        public string PageName => "VTrRequestView";
        ...
        // Constructor
        public VTrRequestViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "VTrRequestList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("VTrRequestList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        public void SetupOtherOptions()
        {
            ...
            body = "<a class=\"btn btn-default btn-sm ew-row-link ew-detail\" data-action=\"list\" href=\"" + HtmlEncode(AppPath("TrRequestDetailList?" + Config.TableShowMaster + "=v_tr_request&" + ForeignKeyUrl("fk_id", id.CurrentValue) + "")) + "\">" + body + "</a>";
            links = "";
            ...
            body = "<a class=\"btn btn-default btn-sm ew-row-link ew-detail\" data-action=\"list\" href=\"" + HtmlEncode(AppPath("TrRequestApproverList?" + Config.TableShowMaster + "=v_tr_request&" + ForeignKeyUrl("fk_id", id.CurrentValue) + "")) + "\">" + body + "</a>";
            links = "";
            ...
            body = "<a class=\"btn btn-default btn-sm ew-row-link ew-detail\" data-action=\"list\" href=\"" + HtmlEncode(AppPath("TrRequestApprovalHistoryList?" + Config.TableShowMaster + "=v_tr_request&" + ForeignKeyUrl("fk_id", id.CurrentValue) + "")) + "\">" + body + "</a>";
            links = "";
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fv_tr_requestview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
