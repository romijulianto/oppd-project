...
public partial class OverridePS {
    ...
    /// logEmailView
    /// </summary>
    public static LogEmailView logEmailView
    {
        get => HttpData.Get<LogEmailView>("logEmailView")!;
        set => HttpData["logEmailView"] = value;
    }

    /// <summary>
    /// Page class for log_email
    /// </summary>
    public class LogEmailView : LogEmailViewBase
    {
        // Constructor
        public LogEmailView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public LogEmailView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class LogEmailViewBase : LogEmail
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "logEmailView";
        ...
        // Page name
        public string PageName => "LogEmailView";
        ...
        // Constructor
        public LogEmailViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "LogEmailList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("LogEmailList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"flog_emailview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
