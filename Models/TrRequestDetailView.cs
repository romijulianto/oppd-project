...
public partial class OverridePS {
    ...
    /// trRequestDetailView
    /// </summary>
    public static TrRequestDetailView trRequestDetailView
    {
        get => HttpData.Get<TrRequestDetailView>("trRequestDetailView")!;
        set => HttpData["trRequestDetailView"] = value;
    }

    /// <summary>
    /// Page class for tr_request_detail
    /// </summary>
    public class TrRequestDetailView : TrRequestDetailViewBase
    {
        // Constructor
        public TrRequestDetailView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TrRequestDetailView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TrRequestDetailViewBase : TrRequestDetail
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "trRequestDetailView";
        ...
        // Constructor
        public TrRequestDetailViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "TrRequestDetailView";
        ...
        // Constructor
        public TrRequestDetailViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "TrRequestDetailList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("TrRequestDetailList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                trRequestDetailView?.PageRender();
            }
            return PageResult();
        }
