...
public partial class OverridePS {
    /// <summary>
    /// mtBackupApproverView
    /// </summary>
    public static MtBackupApproverView mtBackupApproverView
    {
        get => HttpData.Get<MtBackupApproverView>("mtBackupApproverView")!;
        set => HttpData["mtBackupApproverView"] = value;
    }

    /// <summary>
    /// Page class for mt_backup_approver
    /// </summary>
    public class MtBackupApproverView : MtBackupApproverViewBase
    {
        // Constructor
        public MtBackupApproverView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtBackupApproverView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtBackupApproverViewBase : MtBackupApprover
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtBackupApproverView";
        ...
        // Constructor
        public MtBackupApproverViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "MtBackupApproverView";
        ...
        // Constructor
        public MtBackupApproverViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MtBackupApproverList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtBackupApproverList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                mtBackupApproverView?.PageRender();
            }
            return PageResult();
        }
