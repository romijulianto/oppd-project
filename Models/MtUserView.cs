...
public partial class OverridePS {
    ...
    /// mtUserView
    /// </summary>
    public static MtUserView mtUserView
    {
        get => HttpData.Get<MtUserView>("mtUserView")!;
        set => HttpData["mtUserView"] = value;
    }

    /// <summary>
    /// Page class for mt_user
    /// </summary>
    public class MtUserView : MtUserViewBase
    {
        // Constructor
        public MtUserView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtUserView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtUserViewBase : MtUser
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtUserView";
        ...
        public MtUserViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["_UserName"] = keys[0];
            } else {
                RecordKeys["_UserName"] = RouteValues.TryGetValue("_UserName", out obj) && obj != null ? UrlDecode(obj) : Get("_UserName"); // DN
            }
        ...
        // Page name
        public string PageName => "MtUserView";
        ...
        // Constructor
        public MtUserViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("_UserName", out v) && !Empty(v)) { // DN
                _UserName.QueryValue = UrlDecode(v); // DN
                RecordKeys["_UserName"] = _UserName.QueryValue;
            } else if (Get("_UserName", out sv)) {
                _UserName.QueryValue = sv.ToString();
                RecordKeys["_UserName"] = _UserName.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                _UserName.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["_UserName"] = _UserName.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "MtUserList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MtUserList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fmt_userview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
